...
| `uaz-452.zip` در Downloads؛ هنوز به مخزن وارد نشده | Mehozavr، [OpenGameArt: UAZ-452 Utility Van](https://opengameart.org/node/165264) | CC0. | نامزد ون پشتیبانی/امداد ستون. شامل FBX، Blend و بافت‌ها است. |
| `soviet_military_off-road_vehicle.zip` در Downloads؛ هنوز به مخزن وارد نشده | artie31، [OpenGameArt: Soviet military off-road vehicle](https://opengameart.org/content/soviet-military-off-road-vehicle) | CC0؛ ذکر نام سازنده قدردانی می‌شود. | نامزد جیپ نظامی همراه کاروان. شامل FBX است. |
| کامیون‌های کاروان | هنوز وارد نشده‌اند؛ [3D Vehicles Pack](https://opengameart.org/content/3d-vehicles-pack) نامزد تأییدشده است. | CC0؛ پنج کامیون دارد، اما بدون بافت/UV است. | جایگزین سه کامیون مکعبی پس از دریافت ZIP. |
