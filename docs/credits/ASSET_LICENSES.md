...
| `assets/models/vehicles/truck-01.glb` تا `truck-05.glb` | mehrasaur، [3D Vehicles Pack](https://opengameart.org/content/3d-vehicles-pack)؛ ZIP کاربر: `vehicle_pack.zip` | CC0؛ مدل‌ها بدون بافت/UV هستند. | تبدیل‌شده و نگه‌داری‌شده برای استفادهٔ بعدی؛ در حال حاضر به‌خاطر کیفیت بصری، جیپ/ون تکسچردار جای کاروان را گرفته‌اند. |
