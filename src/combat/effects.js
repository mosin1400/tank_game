...
function deploySmokeScreen(){
  ...
  for(let i=0;i<5;i++){const q=p.clone();q.x+=rand(-3,3);q.z+=rand(-3,3);spawnSmoke(q,5,{opacity:.72,vy:2.1,maxLife:5.2,color:0x78766d});}
...
function initFXPools(){
  ...
  for(let i=0;i<(isCoarse?30:54);i++){
