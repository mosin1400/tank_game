(function(global){
  ...
  var presets={low:{pixelRatio:1,shadows:false,bloom:false,effects:.42,label:'کم'},medium:{pixelRatio:1.25,shadows:true,bloom:false,effects:.65,label:'متوسط'},high:{pixelRatio:1.55,shadows:true,bloom:true,effects:.82,label:'زیاد'},cinematic:{pixelRatio:2,shadows:true,bloom:true,effects:1,label:'سینمایی'}};
