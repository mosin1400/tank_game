...
let added=0,removed=0,colliderAdds=0,colliderRemovals=0;
...
if(!active||active.id!=='scene-01'||added!==1||colliderAdds!==2)throw new Error('scene-01 must load one owned layer');
builder.clearActive(); builder.clearActive();
if(removed!==1||colliderRemovals!==2||builder.getActive()!==null)throw new Error('scene cleanup must be idempotent');
